  ...
  return (
    <div className="h-full flex flex-col bg-white dark:bg-[#1e1e1c] rounded-2xl shadow-sm border border-gray-100 dark:border-[#2e2e2c] overflow-hidden">
      ...
      <div className="flex-1 overflow-auto p-6 flex flex-col gap-6">
        <div>
          <h1 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Your digital workspace.</h1>
        ...
        <div className="flex flex-col gap-2.5">
          <p className="text-[10px] font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-0.5">How it works</p>
          {[
            ...
            <div key={label} className="flex items-center gap-3">
              <span className="w-6 h-6 rounded-lg bg-gray-100 dark:bg-[#2a2a28] flex items-center justify-center text-xs text-gray-500 dark:text-gray-400 shrink-0 font-medium">
                {icon}
              </span>
        ...
        <div className="mt-auto pt-2">
          <button
            onClick={onDismiss}
            className="w-full py-2.5 rounded-xl bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 text-sm font-medium hover:bg-gray-700 dark:hover:bg-gray-300 transition-colors cursor-pointer"
          >
            Get started
          </button>
